...
class Ui_MainWindow(object):
        def setupUi(self, MainWindow):
                ...
                502, 20, QSizePolicy.Expanding, QSizePolicy.Minimum)
                ...
                icon1 = QIcon()
                icon1.addFile(u"Recursos/minimizar logo.png",
                ...
                icon2 = QIcon()
                icon2.addFile(u"Recursos/min logo.png",
                        QSize(), QIcon.Normal, QIcon.Off)
                ...
                icon3 = QIcon()
                icon3.addFile(u"Recursos/maxi_logo.png",
                        QSize(), QIcon.Normal, QIcon.Off)
                ...
                icon4 = QIcon()
                icon4.addFile(u"Recursos/salir logo.png",
                        QSize(), QIcon.Normal, QIcon.Off)
        ...
        "")
                ...
                icon5 = QIcon()
                icon5.addFile(u"Recursos/home logo.png",
                        QSize(), QIcon.Normal, QIcon.Off)
                ...
                icon6 = QIcon()
                icon6.addFile(u"Recursos/Captura logo.png",
                        QSize(), QIcon.Normal, QIcon.Off)
                ...
                icon7 = QIcon()
                icon7.addFile(u"Recursos/imagen logo.png",
                        QSize(), QIcon.Normal, QIcon.Off)
                ...
                icon8 = QIcon()
                icon8.addFile(u"Recursos/Archivo logo.png",
                        QSize(), QIcon.Normal, QIcon.Off)
        ...
        def retranslateUi(self, MainWindow):
                ...
                self.btn_seleccionar.setText(QCoreApplication.translate("MainWindow", u"TRANSCRIBIR", None))
