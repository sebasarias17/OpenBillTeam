...
################################################################################
## Form generated from reading UI file 'final_melopqNkEM.ui'
##
...
class Ui_MainWindow(object):
        def setupUi(self, MainWindow):
                if not MainWindow.objectName():
                        ...
                        icon = QIcon()
                        icon.addFile(u"../mockups/1.png", QSize(), QIcon.Normal, QIcon.Off)
                        ...
                        icon1 = QIcon()
                        icon1.addFile(u"../mockups/minimizar logo.png", QSize(), QIcon.Normal, QIcon.Off)
                        ...
                        icon2 = QIcon()
                        icon2.addFile(u"../mockups/min logo.png", QSize(), QIcon.Normal, QIcon.Off)
                        ...
                        icon3 = QIcon()
                        icon3.addFile(u"../mockups/maxi_logo.png", QSize(), QIcon.Normal, QIcon.Off)
                        ...
                        icon4 = QIcon()
                        icon4.addFile(u"../mockups/salir logo.png", QSize(), QIcon.Normal, QIcon.Off)
...
"")
                ...
                icon5 = QIcon()
                icon5.addFile(u"../mockups/home logo.png", QSize(), QIcon.Normal, QIcon.Off)
                ...
                icon6 = QIcon()
                icon6.addFile(u"../mockups/Captura logo.png", QSize(), QIcon.Normal, QIcon.Off)
                ...
                icon7 = QIcon()
                icon7.addFile(u"../mockups/imagen logo.png", QSize(), QIcon.Normal, QIcon.Off)
                ...
                icon8 = QIcon()
                icon8.addFile(u"../mockups/Archivo logo.png", QSize(), QIcon.Normal, QIcon.Off)
                ...
                icon9 = QIcon()
                icon9.addFile(u"../mockups/ajustes logo.png", QSize(), QIcon.Normal, QIcon.Off)
...
"color: rgb(255, 255, 255);")
                ...
                self.label_7.setPixmap(QPixmap(u"../mockups/1.png"))
...
"color: rgb(255, 255, 255);")
                ...
                self.label_9.setPixmap(QPixmap(u"../../../Downloads/OpenBill (6).png"))
...
"color: rgb(255, 255, 255);")
                ...
                self.label_11.setPixmap(QPixmap(u"../../../Downloads/OpenBill (7).png"))
...
"color: rgb(255, 255, 255);")
                ...
                self.label_13.setPixmap(QPixmap(u"../../../Downloads/OpenBill (8).png"))
...
"color: rgb(255, 255, 255);")
                ...
                self.label_15.setPixmap(QPixmap(u"../../../Downloads/OpenBill (9).png"))
...
"color: rgb(255, 255, 255);")
                ...
                self.label_6.setPixmap(QPixmap(u"../mockups/1.png"))
                self.label_6.setScaledContents(True)
                self.label_16 = QLabel(self.ajustes)
                self.label_16.setObjectName(u"label_16")
                self.label_16.setGeometry(QRect(550, 100, 211, 201))
                self.label_16.setPixmap(QPixmap(u"../../../Downloads/WhatsApp Image 2022-07-28 at 9.04.22 PM.jpeg"))
